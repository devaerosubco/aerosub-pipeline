...
import {
  renderSolutions, bindSolutionsControls, openAddSolutionModal, openAddServiceModal, openBulkUploadModal,
  renderProductDrawer, renderServiceDrawer, openStoreShareLink, resetStoreCaches,
} from './views/storeView.js';
...
export function companyById(id){ return DATA.companies.find(c=>c.id===id); }
export function solutionById(id){ return DATA.solutions.find(s=>s.id===id); }
export function serviceById(id){ return DATA.services.find(s=>s.id===id); }
...
export function openProductDrawer(id){
...
export function openLinkModal(title, message, link){
  openModal(`
    <h3>${esc(title)}</h3>
...
export function openModal(html, onMount, opts){
...
export function openConfirmModal(message, onConfirm, confirmLabel){
  openModal(`
    <h3>Are you sure?</h3>
